 ...
 *
 *			cgroup v2 hierarchy with the BPF controller enabled.
 *
 ...
 *
 *			LIRC device path (eg /dev/lircN).
 *
 *		**BPF_PROG_TYPE_SK_SKB**,
 *		**BPF_PROG_TYPE_SK_MSG**
 *
 *			BPF map of socket type (eg **BPF_MAP_TYPE_SOCKHASH**).
 *
 *	Return
 *		Returns zero on success. On error, -1 is returned and *errno*
 *		is set appropriately.
 ...
 *		one of the following formats depending on the BPF object type
 *		of *bpf_fd*:
 *
 ...
 *		  from the map. This is at least *count* elements.
