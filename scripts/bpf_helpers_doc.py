...
class PrinterRST(Printer):
    """
    A generic class for printers that print RST. Printers should be created
    with a HeaderParser object, and implement a way to print API elements in
    the desired fashion.
    @parser: A HeaderParser with objects to print to standard output
    """
    def __init__(self, parser):
...
class PrinterSyscallRST(PrinterRST):
    ...
    used to generate a manual page for the helpers.
    @parser: A HeaderParser with SyscallCommand objects to print to standard
             output
    """
    def __init__(self, parser):
